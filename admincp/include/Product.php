...
class Product {
...

	{
		...
		if($category_key == 'sale-off'){
			...
			$products  = GetRows('products_id,products_key,products_name,keywords,description,products_description,product_detail,products_image,products_price,product_encourage,price_unit,p_attribute,p_type,p_unit,p_color,categories_id,manufacturer','products',"products_status = 1 and  product_encourage <> ''");
...

		{
			...
			if($category['level'] == 1){
				...
				$products  = GetRows('products_id,products_key,products_name,keywords,description,products_description,product_detail,products_image,products_price,product_encourage,price_unit,p_attribute,p_type,p_unit,p_color,categories_id,manufacturer','products','products_status = 1 and categories_id='.$category['categories_id']);
	...
	public static function getProductsByCategoryKeyLimitOrderBy($category_key,$limit_start,$limit_end,$order_by_type=1)//1: ten san pham tang. 2: gia tang ,. 3: ten san pham giam. 2: gia giam
