<?php
		...
		if(check_valid($id)) //fill data on textbox
		{
		...
		if(isset($_POST['btnadd']))
		{
			...
			if(check_cats_name(input($catname),$id,$parent_id)) 
			{
			...
			if(empty($error))
			{
				...
				else
				{
					...
					$sql = "INSERT INTO categories(categories_name,keywords,
												   description,parent_id,
												   level,sort_order,categories_status,
												   date_added,language)
