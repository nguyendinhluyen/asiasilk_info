<?php
	...
	// CAC MUC CAN KIEM TRA
	// KIEM TRA TEN DANG NHAP KHONG DUOC TRUNG LAP VA PHAI CO SO KY TU NHAT DINH
	// KIEM TRA GO LAI PASSWORD DUNG
	// KIEM TRA SO KY TU CUA PASSWORD
	...
	if(isset($_GET['id']))
	{
		...
		$row = GetOneRow('user_name, checked_box_save','admin_control_user','idadmin_control_user ='.$id);
			...
			{				
				...
				{						
					...
					{	
						...
						{
							$error = "Mật khẩu và mẫu khẩu nhập lại không trùng!";								
						}												
					}	
