...
<div class = "content_con">
    ...
    <div class ='err' style = 'margin-left:100px'>{error}</div>        
        <p>
            ...
            <input type = 'text' name='loginusername' id='loginusername' value = "{loginusername}" class ='fieldinput'> <font color ='red'>*</font> ({5char})
		</p>
	  ...
	  <div id='passwdRating' style ='margin-left:100px''>
		...
		<table style="margin-left:-4px; margin-top:10px; margin-bottom:20px">		
            ...
            <tr>
                <td  width="276">
                	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <input type="checkbox" id="check_box_admin_18" name="check_box_admin_18" value="1" {checked_18} >Danh sách tin tức</input> 
                </td>
                <td width="188">             
                    <input type="checkbox" id="check_box_admin_19" name="check_box_admin_19" value="2" {checked_19}>Tin tức chung</input> 
                </td>        
            </tr>
             <tr>
                <td  width="276">
                	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <input type="checkbox" id="check_box_admin_20" name="check_box_admin_20" value="1" {checked_20}>Trợ giúp</input> 
                </td>                
            </tr>
