...
<!--<script type="text/javascript" src="../jgallery/jss/swfupload/swfupload.js"></script>
<script type="text/javascript" src="../jgallery/jss/swfupload/handlers.js"></script>
<script type="text/javascript">
		var swfu;
		window.onload = function () {
			swfu = new SWFUpload({
				// Backend Settings
				upload_url: "../jgallery/jss/swfupload/upload/upload.php",
				...
				// Button Settings
				button_image_url : "../jgallery/images/picture_up.png",
				button_placeholder_id : "spanButtonPlaceholder",
				button_width: 180,
				button_height: 40,
				button_text : '<span class="button">Chọn file ảnh <span class="buttonSmall">(2 MB Max)</span></span>',
				...
				// Flash Settings
				flash_url : "../jgallery/jss/swfupload/swfupload.swf",
...
<p><label style="font-weight:bold;color:green;margin-bottom:3px; font-size:20px; margin-left:3px">Quận</label><br style="clear:both"/>

<!--<input class="inputgallery" type="text" name="galary_district_name" value="{galary_district_name}" />-->
...
<p><label style="font-weight:bold;color:green;margin-bottom:3px; margin-left:3px; margin-top:20px">Giá bắt đầu <span style="color:#F00">*</span></label><br style="clear:both"/><input class="inputgallery" type="text" id ="galary_begin_price" name="galary_begin_price" value="{galary_begin_price}"onkeyup="javascript:Money_CheckCorrect('galary_begin_price');"/><span style="font-size:14px">VNĐ</span></select>

</p>
<p><label style="font-weight:bold;color:green;margin-bottom:3px; margin-left:3px">Giá kết thúc <span style="color:#F00">*</span></label><br style="clear:both"/><input class="inputgallery" type="text" id="galary_end_price" name="galary_end_price" value="{galary_end_price}" onkeyup="javascript:Money_CheckCorrect('galary_end_price');"/><span style="font-size:14px">VNĐ</span></p>
<p><label style="font-weight:bold;color:green;margin-bottom:3px; margin-left:3px">Chi phí <span style="color:#F00">*</span></label><br style="clear:both"/><input class="inputgallery" type="text" id="galary_fee" name="galary_fee" value="{galary_fee}" onkeyup="javascript:Money_CheckCorrect('galary_fee');"/><span style="font-size:14px">VNĐ</span></p>
