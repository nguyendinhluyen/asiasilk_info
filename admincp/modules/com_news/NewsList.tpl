...
<div class = "title" style ="text-indent:10px">Quản lý tin tức</div>
	...
	<div style = "float:left">
		...
		<!--BEGIN_NEWS-->
				...
				<div class = "con_list_con" style = "width:50px;background-color:{color};height:30px;"><a href="?show=OptNews&id={id}&p={p}&order={oderby}&opt={opt}">{lag_edit}</a></div>
	...
	<input style="{style_display_btAdd}" class = "button" type = "button" value = "Thêm tin" {status} onclick="window.location='./?show=OptNews&opt={opt}&p={p}&order={oderby}'">
    
	<input class = "button" style="display: none;" type = "submit" name = "btnNewswait" value = "Tin đón đợi" onclick = "return chkselected();">
