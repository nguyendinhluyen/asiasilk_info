...
<div class = "title" style ="text-indent:10px">Quản lý tin tức</div>
	...
	<div style = "float:left">
			<div class = "title" style = 'width:851px'>
				...
				<div class = "con_title" style = "width:250px"><a href = './?show=NewsOpt&opt={opt}&order=name&p={p}'>Tiêu đề</a></div>
				<div class = "con_title" style = "width:90px">Hình ảnh</div>
				<div class = "con_title" style = "width:100px"><a href = './?show=NewsOpt&opt={opt}&order=catalogue&p={p}'>Thuộc danh mục</a></div>
				<div class = "con_title" style = "width:90px"><a href = './?show=NewsOpt&opt={opt}&order=status&p={p}'>{lag_status}</a></div>
				<div class = "con_title" style = "width:110px;border:0px"><a href = './?show=NewsOpt&opt={opt}&order=dateadd&p={p}'>{lag_date_create}</a></div>
				<div class = "con_title" style = "width:110px;border:0px"><a href = './?show=NewsOpt&opt={opt}&order=datemodifiled&p={p}'>{lag_date_modifiled}</a></div>
			</div>
			<div>
		<!--BEGINLIST_NEWS-->
		<!--BEGIN_NEWS-->
				...
				<div class = "con_list_con" style = "width:100px;background-color:{color};height:30px;">{news_catalogue}</div>
