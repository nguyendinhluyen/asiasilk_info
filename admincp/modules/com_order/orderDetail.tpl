...
<p style="float:left;width:150px;clear:both">{lagphone} :</p><b>{phone}</b><br style="clear:both">
...
<p style="float:left;width:150px;clear:both">{lagphone} :</p><b>{phonereceiver}</b><br style="clear:both">
...
<p><b style="font-size:14px"> Đơn hàng </b></p>
	...
	<div style = "float:left">
			<div class = "title" style = 'width:851px'>
                ...
                <div class = "con_title" style = "width:250px;text-indent:10px">{lagproductname}</div>
	...
	<div>
		<!--BEGINLIST_CATALOGUE-->
		<!--BEGIN_CATALOGUE-->
        		 <div {hidden} class = "con_list_con" style = "width:35px;background-color:{color};height:30px;"><a href='./?show=orderdetail&id={id}&action=del&id_sp={id_sp}'>&nbsp;Xóa</a></div>
                 
                 <div {hidden} class = "con_list_con" style = "width:35px;background-color:{color};height:30px;"><a href='./?show=edit_orderdetail&id_sp={id_sp}'>&nbsp;Sửa</a></div>
        
				<div class = "con_list_con" style = "width:250px;height:30px;text-indent:10px">
				{productName} {productType}
                </div>
				<div class = "con_list_con" style = "width:170px;height:30px;">{quanty}</div>
                
				<div class = "con_list_con" style = "width:180px;height:30px;">{price}</div>
                
				<div class = "con_list_con" style = "width:150px;height:30px">{total}</div>
...
<div style="float: right;  margin-right: -750px; clear:both; margin-top: 10px"><b>Tổng tiền sản phẩm: </b><b style="color: red;">{tongtien}</b> <span style="color:#F00;"><b>VNĐ </b></span>

<br>

<p style="float:left;width:1000px;clear:both;">
<!--<b>Tổng tiền: </b><b style="color:#F00">{total_money}</b><br>-->
</p>
...
<form name="timkiem">
    ...
    <div style="float:left;width:450px;margin:5px;padding-top:20px" {hidden}>
     
	       <b>Thêm sản phẩm</b>
           
	       <input value = "{name_search}" type="text" size="20" name = "searchfield" id="inputString" style="width:200px"/>
	       
	       <input type ='submit' value ='Search' class ='button' style="width:70px; height:24px"/>
	...
	<input type="hidden" name="id" value="{order_id}"/>
	 <div style="float:left;width:auto;margin:5px;padding-top:20px">
		  ...
		  <!--BEGIN_PRODUCT-->
	       <tr>
		       <td>
               		<input type="checkbox" id="chkName[]{i}" name="chkName[]" value="{id_pro}" {function}/>
               
               		<input type="checkbox" hidden="hidden" value="{p_type}" id="chkType[]{i}"/>
		       	...
		       	<td><img alt="" src="../../upload/product/thumb/{image_pro}" width="100px"></td>
		       	<td>
                	<input type="text" name="price_pro[]" id ="price_pro[]{i}" value="{price_pro}" size="8" onkeyup="javascript:Money_CheckCorrect('price_pro[]{i}');" style="width:100px"/>
                	<input type="text" name="type_product[]" id ="type_product[]{i}" hidden="hidden" value="{type_product}" size="8"  style="width:100px"/>
                </td>
                
		       	<td><input type="text" name="quantity[]" id="quantity[]{i}" value="1" size="4"onkeyup="javascript:Money_CheckCorrect('quantity[]{i}');" style = "width:50px"/></td>

                <td width="200px">
                	<span id = "product_type{i}">{product_type}</span>
                </td>
