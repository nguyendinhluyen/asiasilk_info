...
<div class = "title" style ="text-indent:10px">{lag_order_manager}</div>
	...
	<div style = "float:left">
			<div class = "title" style = 'width:851px'>
				...
				<div class = "con_title" style = "width:180px">Email</div>			
		...
		<!--BEGIN_CATALOGUE-->
                ...
                <div class = "con_list_con" style = "width:30px;background-color:{color};height:30px;"><a href='./?show=order&action=del&id={id}'>{lag_del}</a></div>
				...
				<div class = "con_list_con" style = "width:180px;background-color:{color};height:30px">{email}</div>
