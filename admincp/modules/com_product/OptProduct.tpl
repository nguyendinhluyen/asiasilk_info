    ...
    <div class = "title" style="font-family:Arial, Helvetica, sans-serif; font-size:12px">{panel_add_update_product} </div>
    <div class = "content_con">        
        <div style ="float:left;width:150px; font-family:Arial, Helvetica, sans-serif; font-size:12px">
        	<p style = 'margin-left:65px;font-weight:bold'>{image}</p>
            <p style = "margin-left:45px">{ImgThumb} {ImgDel} 
            	<a href = '#' onclick = "javascript:history.back(1)"><img src='../style/images/back.gif'></a>
            </p>
            <div class = "img_show" style = "width:135px; height:135px">
                {imagesrc}
          	</div>
            <br/>
            <br/>
            ...
            <br/>
           	<form method='POST' enctype='multipart/form-data' 
				...
				<p>
                	<label style = "margin-top:5px">&nbsp;&nbsp;&nbsp;Hình minh họa</label>
                    <input size ='1' 
                    	   name ='image_list[]' 
                           id ='image_list' 
                    	   type ="file" 
                           multiple style ="margin-left: 8px; margin-top:5px"> </input>
                </p>
                <input type="hidden" 
                	   name = "id_product" 
                       value="{id_product}"></input>
           	</form>
        </div>
        <form method='POST' enctype='multipart/form-data' 
        	  				id = "frm" 
        	...
        	<div style="float:left;padding-left:25px; font-family:Arial, Helvetica, sans-serif; font-size:12px">
            	...
            	<p>
           	 	...
           	 	<p>
                	<div id="show_list_img" style="border: 1px solid; width: 500px;" >
            	...
            	<label>Mô tả ngắn : <br/></label>
                <textarea name = "products_description" 
                		  cols = "66" 
                          rows = "5">{products_description}</textarea>                        
                <label>Thuộc tính : </br></br></label>				
              
                <table  border="1" cellpadding="0" cellspacing="0" width="84.5%">
                    <tr>
                    ...
                    <tr>
                        <td align="left" >
                            Tên thuộc tính : <input type="textbox" 
                            						  id="attribute_name" 
                                                      name="attribute_name" 
                                                      value="{p_attribute}" 
                        ...
                        <td align="center" >
                        <br/>
                            Loại : <input type="textbox" 
                            			  id="type_name" 
                                          name="type_name" 
                                          style="width:200px;"/><br/>
                            &nbsp;&nbsp;Giá : <input type="textbox" 
                            						 id="type_price" 
                                                     name="type_price" 
                                                     style="width:200px;" 
                            ...
                            <input type="button" 
                                   ...
                                   name="type_btn_del" 
                                   value="Xóa"
                                   onclick="removeOptionSelectedType();"/><br/><br/>
                        </td>
                    </tr>
                    <tr>
                        <td >			
            ...
            <p>            
                <label>1. Giới Thiệu </br> </br> &nbsp; &nbsp; Sản Phẩm</label>
               	<script>
            ...
            <p>            
            	<label>3. Phù Hợp Cho</label>
               	<script>
					var oEdit3 = new InnovaEditor("oEdit3");		
					oEdit3.arrStyle = [["BODY",false,"","font:10px verdana,arial,sans-serif;"]];					
					oEdit3.width="550";
					oEdit3.height=200;
            ...
            <p>            
           		<label>4. Nguyên Liệu </br></br> &nbsp; &nbsp; Thành Phần </label>
               	<script>
					var oEdit4 = new InnovaEditor("oEdit4");		
					oEdit4.arrStyle = [["BODY",false,"","font:10px verdana,arial,sans-serif;"]];					
					oEdit4.width="550";
					oEdit4.height=200;
    		...
    		<p>            
           		<label>5. Phân Tích </br></br> &nbsp; &nbsp; Đảm Bảo </label>
               	<script>
					var oEdit5 = new InnovaEditor("oEdit5");		
					oEdit5.arrStyle = [["BODY",false,"","font:10px verdana,arial,sans-serif;"]];					
					oEdit5.width="550";
					oEdit5.height=200;
            ...
            <p>            
           		<label>6. Hướng Dẫn </br></br> &nbsp; &nbsp; Sử Dụng </label>
               	<script>
					var oEdit6 = new InnovaEditor("oEdit6");		
					oEdit6.arrStyle = [["BODY",false,"","font:10px verdana,arial,sans-serif;"]];					
					oEdit6.width="550";
					oEdit6.height=200;
            ...
            <p>            
           		<label>7. Hướng Dẫn </br></br> &nbsp; &nbsp; Bảo Quản </label>
               	<script>
					var oEdit7 = new InnovaEditor("oEdit7");
					oEdit7.arrStyle = [["BODY",false,"","font:10px verdana,arial,sans-serif;"]];					
					oEdit7.width="550";
					oEdit7.height=200;
            ...
            <p>            
               	...
               	<script>
					...
					oEdit8.arrStyle = [["BODY",false,"","font:10px verdana,arial,sans-serif;"]];					
					oEdit8.width="550";
					oEdit8.height=200;
            ...
            <p>            
           		<label>9. Khuyến Khích </label>
               	<script>
					var oEdit9 = new InnovaEditor("oEdit9");
					oEdit9.arrStyle = [["BODY",false,"","font:10px verdana,arial,sans-serif;"]];					
					oEdit9.width="550";
					oEdit9.height=200;
            ...
            <p>            
           		<label>10. Đóng Gói </br></br> &nbsp; &nbsp; &nbsp; &nbsp;Thể Tích</label>
               	<script>
					var oEdit10 = new InnovaEditor("oEdit10");
					oEdit10.arrStyle = [["BODY",false,"","font:10px verdana,arial,sans-serif;"]];					
					oEdit10.width="550";
					oEdit10.height=200;
            ...
            <p>            
           		<label>11. Nhà Sản Xuất</label>
               	<script>
					var oEdit11 = new InnovaEditor("oEdit11");
					oEdit11.arrStyle = [["BODY",false,"","font:10px verdana,arial,sans-serif;"]];					
					oEdit11.width="550";
					oEdit11.height=200;
            ...
            <p>            
           		<label>12. Xuất Xứ</label>
               	<script>
					var oEdit12 = new InnovaEditor("oEdit12");
					oEdit12.arrStyle = [["BODY",false,"","font:10px verdana,arial,sans-serif;"]];					
					oEdit12.width="550";
					oEdit12.height=200;
