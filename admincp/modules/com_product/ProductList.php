<?php
...

	{
...

		{
			...
			{
				$where = " and categories_id in (select categories_id from categories where parent_id='".$catlist."')";
			}
	...
	if($_GET['order'] != 'price_asc' && $_GET['order'] != 'price_desc')
	{
		...
		$sql = "Select products_id from products where language='".$_SESSION['lag']."' ".$where.$_SESSION['QUERY_P'];
		...
		$sql = "Select * from products where language='".$_SESSION['lag']."' ".$where.$_SESSION['QUERY_P']." order by $orderby limit $limitvalue,$pp";
...
//////////////////////////////////////////////////////////////////////		
	//VI TRI THEM DIEU CHINH SAP XEP TANG DAN HOAC GIAM DAN THEO GIA
	else 
	{				
		...
		$sql = "Select * from products where language='".$_SESSION['lag']."' ".$where.$_SESSION['QUERY_P'];
