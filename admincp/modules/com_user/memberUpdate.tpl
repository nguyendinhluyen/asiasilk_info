...
<script>  	
	...
	{				
		...
		<div class="title">{title}</div> 
			...
			<div class="user_left">					  
				<table style="text-align: left; float:left; margin-top:10px" border="0px;">
					<tr>
                    	<td align="center"><b style="font-family:Cambria; font-size:14px">Ảnh đại diện</b></td>
                    </tr>
					<tr>
                    	<td align="center">
                        	<img alt="" src="../../upload/avatar/{avatar}" width="120px" height="140px;">
                        </td>
                    </tr>
					<tr>
                    	<td>&nbsp;</td>
            ...
            <div class="user_right" style = "float:left; margin-left:20px">
				<div class="newsPersonal updateUser" style="display: block;">
					<div class="top_newsPersonal" style="margin-top:10px">
                ...
                <div class="newsPersonal_inside">
					<div class="group_listing_input" id="group_listing_input">								
						<div class="listing_input" style="margin-bottom:10px">
                            <div class="post_label_container"  style="width: 160px">
                                <label class="postLabel" style="width: 150px; margin-bottom:10px">Tên đăng nhập</label>
                            </div>
							<div class="post_label_container" style= "width:auto">
								<label class="postLabel" style= "width:auto">: {name}</label>
							</div>
						</div>
                        <div class="listing_input">
                            <div class="post_label_container" style="width: 160px" >
                                <label class="postLabel"  style="width: 150px; margin-bottom:10px" >Thành viên</label>
                            </div>
                            <div class="post_label_container" style= "width:auto">
                                <label class="postLabel" style= "width:auto">
                                    <b style="color:#AA1F00; font-size:14px; font-family:Cambria">: {level}</b>
                                </label>
                            </div>
                        </div>                                    
                        <div class="listing_input">
                            <div class="post_label_container" style="width: 160px">
                                <label class="postLabel" 
                                	   style="width: 150px; margin-bottom:10px">Chiết khấu thành viên</label>
                            </div>
                            <div class="post_label_container" style= "width:auto">
                                <label class="postLabel" style= "width:auto">
                                    <b style="color:#AA1F00; font-size:14px; font-family:Cambria">: {discount_level}</b>
                                </label>
                            </div>
                        </div>                                                                                                            
                        <div class="listing_input">
                            <div class="post_label_container" style="width: 160px">
                                <label class="postLabel" 
                                	   style="width: 150px; margin-bottom:10px">Điểm được sử dụng</label>
                            </div>
                            <div class="post_label_container" style= "width:auto">
                                <label class="postLabel" style= "width:auto">
                                    <b style="color:#AA1F00; font-size:14px; font-family:Cambria">: {score}</b>
                                </label>
                            </div>
                        </div>                                   	
                        <div class="listing_input">                                   
                            <div class="post_label_container" style="width: 160px">
                                <label class="postLabel" 
                                	   style="width: 150px; margin-bottom:10px">Điểm chưa được sử dụng</label>
                            </div>									
                            <div class="post_label_container" style= "width:auto">
                                <label class="postLabel" 
                                	   style= "width:auto; font-size:12px"><b>: {unusedscore}</b></label>
                            </div>                                        
                        </div>
				</div>								
			</div>		
       	<form method='POST' id = "frm" name = "frm" enctype='multipart/form-data'>
			<div class="newsPersonal updateUser" style="display: block;float:left">
				<div class="top_newsPersonal">
					<div class="ltop_newsPersonal"></div>
						<h2 class="lstitle" style="background-color:#EAF3FE;
                        						   margin-bottom:10px; 
                                                   border-radius:7px;
					...
					<div class="newsPersonal_inside">
						<div class="group_listing_input" id="group_listing_input">
							<div class="listing_input">
								<div class="post_label_container" style="margin-bottom:10px">
									<label class="postLabel">Họ & tên :</label>
								</div>
									<input id="fisrtname" 
                                    	   name="name" 
                                           type="text" 
							...
							<div class="listing_input">
								<div class="post_label_container">
									<label class="postLabel" >Ngày sinh:</label>
								</div>
								<input id="birthday" 
                                	   name="birthday" 
                                       type="text" 
							...
							<div class="listing_input">
								...
								<select id="item_gender" name="gender" class="sex">
									<option value="1" selected {selected1} >Anh</option>
                                    <option value="0" {selected2}>Chị</option>
								</select>
							</div>
							<div class="listing_input_new">
								<div class="post_label_container">
									<label class="postLabel" style="margin-bottom:10px">Địa chỉ:</label>
								</div>                                                                                
                                 <textarea rows="3" name="address" 
                                 				    style ="text-align:left;width: 451px;" disabled>{address}</textarea>                                                                                         
                       		<div>                                         
                            <!--Them tinh thanh va quan huyen-->    	        
                            <table id = "info_Country_City_District" style="display:block">   		            
								 <tr>
    								<td id="info_Country">
                                    	<p id="p_country"  style="margin-bottom:10px;"> Quốc Gia <span style="color:red">*</span></p>
                                          	<select id = "country" style="width: 135px; margin-right:20px">
                                               	<option>Việt Nam</option>
                                            </select>
                                  	</td>                
                                    <td id = "info_City">
                                       	<p id="p_city" style="margin-bottom:10px"> Thành phố <span style="color:red">*</span></p>
                                        ...
                                        <td id = "info_District">
                                         	<p id="p_district" style="margin-bottom:10px">Quận/Huyện <span style="color:red">*</span></p>
                                          ...
                                          <table id="table_Dia_Chi">	    	
                                            <tr>                                               
                                            	<td id = "info_ward">                		  
                                                        <p id = "text_ward"  style="margin-bottom:10px">Phường <span style="color:red">*</span></p>
                                                        <input type="text" 
                                                        	   id ="tags" 
                                                ...
                                                <td id = "info_street">                                                    
                                                        <p id = "text_street" style="margin-bottom:10px" >Đường <span style="color:red">*</span></p>
                                                        <input type="text" 
                                                        	   id ="tags_street" 
                                                ...
                                                <td id = "info_adress">                                                                                       
                                                        <p id = "text_address" 
                                                           style="margin-bottom:10px">Số nhà <span style="color:red">*</span></p>
                                                        <input type="text" 
                                                        	   style="width:130px" 
                                        ...
                                        <table id="table_Chung_Cu">	    	
                                            <tr>
                                                <td id = "info_adress_Chung_Cu">                                                                                       
                                                        <p id = "text_address_Chung_Cu" 
                                                           style="margin-bottom:10px">Chung cư / Tòa nhà </p>
                                                        <input type="text" 
                                                        	   style="margin-right:20px;width:130px; margin-bottom:10px" 
                                                ...
                                                <td id = "info_floor_Chung_Cu">                                                    
                                                        <p id = "text_floor_Chung_Cu" style="margin-bottom:10px; margin-top: -4px">Lầu </p>
                                                        <input type="text" 
                                                ...
                                                <td id = "info_room_Chung_Cu">                		  
                                                        <p id = "text_room_Chung_Cu" style="margin-bottom:10px; margin-top:-4px">Căn hộ</p>
                                                        <input type="text" 
									...
									<div class="listing_input">
										<div class="post_label_container">
											<label class="postLabel" 
                                            	   style="margin-bottom:10px">Điện thoại:</label>
										</div>
										<input id="phone" 
                                        	   class="phone" 
                                               name="phone" 
									...
									<div class="listing_input">
										<div class="post_label_container" style="clear:both">
											<label class="postLabel" 
                                            	   style="margin-bottom:10px">Email: </label>
										</div>
                                        <input id="email" 
                                    	   	   name="email" 
                                               type="text" 
                                               value="{email}"                                     	      
                                               style="margin-bottom:10px; margin-left:2px; width:300px"/>&nbsp;<span style="color:red">*</span>
									</div>                                                         
									<div class="clear"></div>
                                    <div class="listing_input">
										<div>
											<label class="postLabel" 
                                            	   style="margin-bottom:10px">Ảnh đại diện:</label>
											<input type="file" 
                                            	   name="avatar" 
                                                   class="input_reg" />
                                        </div>										
									...
									<div class="button_listing_input" 
                                         ...
                                         margin-bottom:20px">
                                            <input id="cmd_submit_update_user" 
                                             	   ...
                                             	   value="Cập nhật" 
                                             	   type="submit" 
                                            	   style="font-size:15px; font-family:Cambria"/>
                                    </div>
								</div>								
							</div>
						</div>
