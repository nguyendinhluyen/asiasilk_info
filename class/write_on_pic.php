...
class Write_On_Pic
{
	...
	var $outputType 	= 'jpg';					// output file format: 			JPG, PNG, GIF, BMP
	var $text 		= 'http://yeumuaban.com';		// text to write on image
	...
	var $backFlag 		= true;						// flag of background: 			TRUE, FALSE
	var $backColor 		= array(200, 0, 0);			// background color: 			RGB decimal
	var $marginH 		= 20;						// text horizonatal margin in pixels
	var $marginV 		= 20;						// text vertical margin in pixels
	var $alignH 		= 'RIGHT';					// text horizonatal position, 	LEFT | CENTER | RIGHT
	...
	var $save 			= true;					// save out file: 				TRUE, FALSE
