            ...
            $(document).ready(function(){
                ...
                <div id="product">
                    ...
                    <div class="col1_content">
                        <div class="clear"></div> 
                        <div id="detail3" style="font-family:Cambria; font-size:14px">
                            <ul class="tabs">                                
                                <li><a href="#tab4">Tin tức</a></li> <!--Thú ý-->
                                <li><a href="#tab1">Cơ hội thăng tiến</a></li>
                                <li><a href="#tab5">Tuyển dụng</a></li> <!--Dinh dưỡng-->
