        ...
        <div id="detail3">
            ...
            <div id="tab_container">
                <div id="tab1" class="tab_content">
                        ...
                        <li>
                            <div class="product_detail">
                                <div class="product_col">
                                    <div class="product_tit" style="height:50px; width:170px">
                    ...
                    <div align="center">
                        <div class="pagination">{product_page}</div>
                    <!-- END PAGE NAVIGATION -->
                    </div>
                    <!-- end product -->
                </div>
                ...
                <div id="tab3" class="tab_content">
                    ...
                    <!-- BEGIN PAGE NAVIGATION -->
                    <div align="center">
                        <div class="pagination" style="font-size: 14px">{entertainment_page}</div>
                    <!-- END PAGE NAVIGATION -->
                    </div>
                    <!-- end entertainment -->
                </div>
