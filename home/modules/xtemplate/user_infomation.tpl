...
<div id="product">
	<div id="breakcrumb" style="font-size:14px; font-family:Cambria; margin-top:20px">{breadcrumbs_path}</div>                     
    <div class="news_main">
     	<div style="clear:both"></div>
			<div class="user_left">				
            	<table style="text-align: left;" border="0px;">
					...
					<tr>
                    	<td align="center">
                        	<img alt="" src="{linkS}upload/avatar/{avatar}" width="120px" height="140px;">
                       	</td>
                   	</tr>
					<tr><td>&nbsp;</td></tr>					
					<tr><td>
