...
<div id="product">
								...
								<div class="group_listing_input" id="group_listing_input">
									...
									<div class="listing_input">
										...
										<div class="post_label_container"  style="width: 160px">
											...
											<label class="postLabel" style="width: auto">Tên đăng nhập : </label>
									...
									<div class="listing_input">
										...
										<div class="post_label_container"  style="width: 160px" >
											...
											<label class="postLabel"  style="width: 160px" >Thành viên :</label>

										</div>

										<div class="post_label_container" style= "width:auto">

											<label class="postLabel" style= "width:auto"><b style="color:#AA1F00; font-size:14px; font-family:Cambria">{level}</b></label>
                                    ...
                                    <div class="listing_input">
										...
										<div class="post_label_container" style="width: 160px">
											...
											<label class="postLabel" style="width: 160px">Chiết khấu thành viên : </label>

										</div>

										<div class="post_label_container" style= "width:auto">

											<label class="postLabel" style= "width:auto"><b style="color:#AA1F00; font-size:14px; font-family:Cambria">{discount_level}</b></label>
                                    ...
                                    <div class="listing_input">
										...
										<div class="post_label_container" style="width: 160px">
											...
											<label class="postLabel" style="width: 160px">Điểm được sử dụng :</label>

										</div>

										<div class="post_label_container" style= "width:auto">

											<label class="postLabel" style= "width:auto"><b style="color:#AA1F00; font-size:14px; font-family:Cambria">{score}</b></label>
                                    ...
                                    <div class="listing_input">
                                   		...
                                   		<div class="post_label_container" style="width: 160px">
											...
											<label class="postLabel" style="width: 160px">Điểm chưa được sử dụng :</label>

										</div>
										
                                        <div class="post_label_container" style= "width:auto">

											<label class="postLabel" style= "width:auto"><b>{unusedscore}</b></label>
                ...
                <form method='POST' id = "frm1" name = "frm1" enctype='multipart/form-data' action="{linkS}cap-nhat-thong-tin" >
					...
					<div class="newsPersonal updateUser" style="display: block; ">
							...
							<div class="top_newsPersonal">
								...
								<h2 class="lstitle">Cập nhật thông tin cá nhân <span id="hint_update_user"></span></h2>
							...
							<div class="newsPersonal_inside">
								...
								<div class="group_listing_input" id="group_listing_input">
									...
									<div class="listing_input">
										...
										<input id="fisrtname" name="name" type="text" value="{name}" class="account_text_input required">
									...
									<div class="listing_input">
										...
										<input id="birthday" name="birthday" type="text" value="{birthday}" class="account_text_input required">
									...
									<div class="listing_input_new">
										...
										<div class="post_label_container">
											...
											<label class="postLabel">Địa chỉ:</label>
										</div>
                                                                                
                                         <textarea rows="3" name="address" style ="text-align:left;width: 392px;" disabled >{address}</textarea>
									...
									<div class="listing_input">
										...
										<div class="post_label_container">
											...
											<label class="postLabel">Điện thoại:</label>

										</div>

										<input id="phone" name="phone" type="text" value="{phone}" class="phone"/>
									...
									<div class="listing_input">
										...
										<div class="post_label_container">
											...
											<label class="postLabel">Email: </label>
									...
									<div class="listing_input">
										...
										<div class="post_label_container">
											...
											<label class="postLabel">Ảnh đại diện:</label>

										</div>

										<input type="file" name="avatar" class="input_reg" />
									...
									<div class="button_listing_input">
                                    	<input id="cmd_submit_update_user" name="cmd_submit_update_user" class="button_update" value="" type="submit"/>
                                    </div>
			...
			<form method='POST' id = "frm" name = "frm" action="{linkS}doi-mat-khau">
					...
					<div class="newsPersonal updateUser" style="display: block; ">
							...
							<div class="top_newsPersonal">
								...
								<h2 class="lstitle">Thay đổi mật khẩu <span id="hint_update_user"></span></h2>
								...
								<div class="group_listing_input" id="group_listing_input">
									...
									<div class="listing_input">
										...
										<div class="post_label_container">
											...
											<label class="postLabel">Mật khẩu cũ:</label>

										</div>

										<input id="pass_old" name="pass_old" type="password" value="" class="account_text_input required">
									...
									<div class="listing_input">
										...
										<div class="post_label_container">
											...
											<label class="postLabel">Mật khẩu mới:</label>

										</div>

										<input id="pass_new" name="pass_new" type="password" value="" class="account_text_input required email">
                                    ...
                                    <div class="listing_input">
										...
										<div class="post_label_container">
											...
											<label class="postLabel">Nhập lại mật khẩu mới:</label>

										</div>

										<input id="pass_confirm" name="pass_confirm" type="password" value="" class="account_text_input required email">
