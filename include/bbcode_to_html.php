...
function BBCodeToHTML($text){
	...
	$patterns[] = "#\[php\]#si";
	$replacements[] = '<div class="php_title">CODE</div><div class="php_code">';
	...
	$patterns[] = "#\[\/(center|left|right|justify|php)\]#si";
	$replacements[] = '</div>';
	...
	$replacements[] = '<object width="$1" height="$2"><param name="movie" value="$3"></param><param name="wmode" value="transparent"></param><embed src="$3" type="application/x-shockwave-flash" wmode="#000" width="$1" height="$2"></embed></object>';
	//transparent
	...
	{
		$output = str_replace('thienduongweb.com/','localhost/thienduongweb/',$output);
	}
	return $output;
}
?>