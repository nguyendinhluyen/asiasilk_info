...
var Sliderman = new function(){
	...
	function Effects(parameters){
		...
		effect.order = validateOption(effect.order, 'snake,straight,swirl,straight_stairs,random');
...
var Sliderman2 = new function(){
	...
	Sliderman2.effect({name: 'fade', fade: true, duration: 400});
	Sliderman2.effect({name: 'move', left: true, move: true, duration: 400});
	Sliderman2.effect({name: 'stairs', cols: 7, rows: 5, delay: 30, order: 'straight_stairs', road: 'BL', fade: true});
	Sliderman2.effect({name: 'blinds', cols: 10, delay: 100, duration: 400, order: 'straight', right: true, zoom: true, fade: true});
	Sliderman2.effect({name: 'rain', cols: 10, delay: 100, duration: 400, order: 'straight', top: true, fade: true});

	Sliderman2.slider = function(parameters){
		setOpacityInit();
